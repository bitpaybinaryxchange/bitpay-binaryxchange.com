!function(e, t) {
    ...
    w.extend = w.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    i = e[t],
                    "__proto__" !== t && s !== i && (c && i && (w.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[t],
    ...
    var T = function(e) {
        var t, n, i, r, o, s, a, l, c, u, f, h, d, p, g, m, v, y, b, _ = "sizzle" + 1 * new Date, w = e.document, E = 0, x = 0, T = le(), C = le(), S = le(), A = le(), D = function(e, t) {
            return e === t && (f = !0),
            0
        }, k = {}.hasOwnProperty, N = [], I = N.pop, O = N.push, j = N.push, L = N.slice, P = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + M + "*(" + q + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + M + "*\\]", F = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", W = new RegExp(M + "+","g"), B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), U = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), V = new RegExp(M + "|>"), $ = new RegExp(F), Q = new RegExp("^" + q + "$"), Y = {
            ID: new RegExp("^#(" + q + ")"),
            CLASS: new RegExp("^\\.(" + q + ")"),
            TAG: new RegExp("^(" + q + "|[*])"),
            ATTR: new RegExp("^" + R),
        ...
        }, K = /HTML$/i, X = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)","ig"), ne = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        try {
            j.apply(N = L.call(w.childNodes), w.childNodes),
        ...
        function ae(e, t, i, r) {
            ...
            g)) {
                ...
                if (n.qsa && !A[e + " "] && (!m || !m.test(e)) && (1 !== E || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    y = t,
                    1 === E && V.test(e)) {
                        for ((u = t.getAttribute("id")) ? u = u.replace(ie, re) : t.setAttribute("id", u = _),
                        a = (p = s(e)).length; a--; )
                            p[a] = "#" + u + " " + be(p[a]);
                        v = p.join(","),
        ...
        h = ae.setDocument = function(e) {
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e === d ? -1 : t === d ? 1 : r ? -1 : o ? 1 : u ? P(u, e) - P(u, t) : 0;
                if (r === o)
                    return he(e, t);
        ...
        (i = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return Y.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && $.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                PSEUDO: function(e, t) {
                    ...
                    return r[_] ? r(t) : 1 < r.length ? (n = [e, e, "", t],
            ...
            ce(function(o, s, a, l) {
                var c, u, f, h = [], d = [], p = s.length, g = o || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        ae(e, t[i], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), m = !e || !o && t ? g : Ee(g, h, e, a, l), v = n ? r || (o ? e : p || i) ? [] : s : m;
                if (n && n(m, v, a, l),
                i)
                    for (c = Ee(v, d),
                    i(c, [], a, l),
                ...
                if (o) {
                    if (r || e) {
                        ...
                        for (u = v.length; u--; )
                            (f = v[u]) && -1 < (c = r ? P(o, f) : h[u]) && (o[c] = !(s[c] = f))
                    }
                } else
                    v = Ee(v === s ? v.splice(p, v.length) : v),
                    r ? r(null, s, v, l) : j.apply(s, v)
            })
        }
        function Te(e) {
        ...
        a = ae.compile = function(e, t) {
            ...
            if (!m) {
                ...
                u = function(e, t, n, s, u) {
                    var f, p, m, v = 0, y = "0", b = e && [], _ = [], w = c, x = e || l && i.find.TAG("*", u), T = E += null == w ? 1 : Math.random() || .1, C = x.length;
                    ...
                    a && y !== v) {
                        ...
                        if (e) {
                            if (0 < v)
                                for (; y--; )
                                    b[y] || _[y] || (_[y] = I.call(s));
                            _ = Ee(_)
                        }
                        j.apply(s, _),
                        u && !e && 0 < _.length && 1 < v + o.length && ae.uniqueSort(s)
                    }
                    return u && (E = T,
                    c = w),
                    b
    ...
    w.each({
        ...
        w.fn[e] = function(n, i) {
            ...
            1 < this.length && (L[e] || w.uniqueSort(r),
            j.test(e) && r.reverse()),
            this.pushStack(r)
        }
    });
                            ...
                            var a = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    g(c) ? r ? c.call(e, s(o, n, M, r), s(o, n, q, r)) : (o++,
                                    c.call(e, s(o, n, M, r), s(o, n, q, r), s(o, n, M, n.notifyWith))) : (i !== M && (a = void 0,
                                    l = [e]),
                                    (r || n.resolveWith)(a, l))
                                }
                            }
    ...
    w.ready.then = W.then,
    "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(w.ready) : (i.addEventListener("DOMContentLoaded", B),
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = Q(i.slice(5)),
                        ee(o, i, r[i]));
    ...
    function ce(e, t, n, i) {
        ...
        , l = a(), c = n && n[3] || (w.cssNumber[t] ? "" : "px"), u = e.nodeType && (w.cssNumber[t] || "px" !== c && +l) && ne.exec(w.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; s--; )
    ...
    function fe(e, t) {
        for (var n, i, r, o, s, a, l, c = [], u = 0, f = e.length; u < f; u++)
            ...
            s = (r = i).ownerDocument,
            a = r.nodeName,
            (l = ue[a]) || (o = s.body.appendChild(s.createElement(a)),
            l = w.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === l && (l = "block"),
            ue[a] = l)))) : "none" !== n && (c[u] = "none",
            X.set(i, "display", n)));
        for (u = 0; u < f; u++)
    ...
    w.event = {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--; )
                    ...
                    d) {
                        ...
                        s && !h.length && (f.teardown && !1 !== f.teardown.call(e, p, m.handle) || w.removeEvent(e, d, m.handle),
                        delete l[d])
                    } else
                        for (d in l)
                            w.event.remove(e, d + t[c], n, i, !0);
                w.isEmptyObject(l) && X.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, o, s, a = w.event.fix(e), l = new Array(arguments.length), c = (X.get(this, "events") || {})[a.type] || [], u = w.event.special[a.type] || {};
            for (l[0] = a,
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        s = {},
                        n = 0; n < l; n++)
                            void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? -1 < w(r, this).index(c) : w.find(r, this, null, [c]).length),
                            s[r] && o.push(i);
                        o.length && a.push({
                            elem: c,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && D(t, "input") && ke(t, "click", Ce),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && D(t, "input") && ke(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function qe(e, t, n, i) {
        ...
        if (h && (o = (r = we(t, e[0].ownerDocument, !1, e, i)).firstChild,
        ...
        o || i)) {
            ...
            if (l)
                ...
                f = 0; f < l; f++)
                    c = a[f],
                    pe.test(c.type || "") && !X.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    function Ue(e, t, n) {
        ...
        return (n = n || We(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = w.style(e, t)),
        !p.pixelBoxStyles() && Fe.test(s) && Be.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    function et(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            ...
            i ? ("content" === n && (l -= w.css(e, "padding" + ie[s], !0, r)),
            "margin" !== n && (l -= w.css(e, "border" + ie[s] + "Width", !0, r))) : (l += w.css(e, "padding" + ie[s], !0, r),
            "padding" !== n ? l += w.css(e, "border" + ie[s] + "Width", !0, r) : a += w.css(e, "border" + ie[s] + "Width", !0, r));
    ...
    function tt(e, t, n) {
        ...
        return (!p.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === w.css(e, "boxSizing", !1, i),
        (o = a in e) && (s = e[a])),
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = Q(t), l = Xe.test(t), c = e.style;
                if (l || (t = Ye(a)),
                s = w.cssHooks[t] || w.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
                "string" == (o = typeof n) && (r = ne.exec(n)) && r[1] && (n = ce(e, t, r),
                o = "number"),
    ...
    w.each(["height", "width"], function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !Ke.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, i) : le(e, Ge, function() {
                        return tt(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var r, o = We(e), s = !p.scrollboxSize() && "absolute" === o.position, a = (s || i) && "border-box" === w.css(e, "boxSizing", !1, o), l = i ? et(e, t, i, a, o) : 0;
                return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - et(e, t, "border", !1, o) - .5)),
    ...
    function ct() {
        rt && (!1 === i.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ct) : e.setTimeout(ct, w.fx.interval),
        w.fx.tick())
    }
    function ut() {
    ...
    function dt(e, t, n) {
        var i, r, o = 0, s = dt.prefilters.length, a = w.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = it || ut(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++)
                c.tweens[o].run(i);
    ...
    w.Animation = w.extend(dt, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, c, u, f = "width"in t || "height"in t, h = this, d = {}, p = e.style, g = e.nodeType && ae(e), m = X.get(e, "fxshow");
            ...
            if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                ...
                "none" === (u = w.css(e, "display")) && (c ? u = c : (fe([e], !0),
                c = e.style.display || c,
                u = w.css(e, "display"),
                fe([e]))),
    ...
    w.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = X.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = w.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                w.queue(this, e, []),
    ...
    w.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (r = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? pt : void 0)),
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, o) {
            ...
            if (a = p = l = r = r || i,
            3 !== r.nodeType && 8 !== r.nodeType && !Et.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(),
            b.sort()),
            u = y.indexOf(":") < 0 && "on" + y,
            ...
            o || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!o && !d.noBubble && !m(r)) {
                    ...
                    Et.test(c + y) || (a = a.parentNode); a; a = a.parentNode)
                        v.push(a),
                        l = a;
                ...
                for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
                    ...
                    (h = u && a[u]) && h.apply && Y(a) && (t.result = h.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), n) || !Y(r) || u && g(r[y]) && !m(r) && ((l = r[u]) && (r[u] = null),
                w.event.triggered = y,
    ...
    w.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, o, s, a, l, c, u, f, h, d, p = w.ajaxSetup({}, n), g = p.context || p, m = p.context && (g.nodeType || g.jquery) ? w(g) : w.event, v = w.Deferred(), y = w.Callbacks("once memory"), b = p.statusCode || {}, _ = {}, E = {}, x = "canceled", T = {
                readyState: 0,
            ...
            if (v.promise(T),
            p.url = ((t || p.url || Tt.href) + "").replace(Mt, Tt.protocol + "//"),
            ...
            null == p.crossDomain) {
                ...
                try {
                    c.href = p.url,
                    c.href = c.href,
                    p.crossDomain = Wt.protocol + "//" + Wt.host != c.protocol + "//" + c.host
                } catch (t) {
                    p.crossDomain = !0
                }
            }
            ...
            o = p.url.replace(jt, ""),
            p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ot, "+")) : (d = p.url.slice(o.length),
            p.data && (p.processData || "string" == typeof p.data) && (o += (St.test(o) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (o = o.replace(Lt, "$1"),
            d = (St.test(o) ? "&" : "?") + "_=" + Ct++ + d),
            p.url = o + d),
            p.ifModified && (w.lastModified[o] && T.setRequestHeader("If-Modified-Since", w.lastModified[o]),
            ...
            function C(t, n, i, a) {
                ...
                c ? (p.ifModified && ((E = T.getResponseHeader("Last-Modified")) && (w.lastModified[o] = E),
                (E = T.getResponseHeader("etag")) && (w.etag[o] = E)),
    ...
    w.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(Kt, "$1" + r) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
    ...
    p.createHTMLDocument = ((Qt = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    w.parseHTML = function(e, t, n) {
        ...
        s = !n && [],
        (o = k.exec(e)) ? [t.createElement(o[1])] : (o = we([e], t, s),
    ...
    w.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, c = w.css(e, "position"), u = w(e), f = {};
